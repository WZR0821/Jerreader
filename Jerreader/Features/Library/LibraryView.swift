...
struct LibraryView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("书架")
            .searchable(text: $searchText, prompt: "搜索书名、作者、系列、文件夹或标签")
            .toolbar {
                    ...
                    Menu {
                        ...
                        Section("书架") {
                            ...
                            Button {
                                ...
                                Label("批量整理书籍", systemImage: "checklist")
                            }
        ...
        .confirmationDialog(
            ...
            Text("将同时删除书架记录、本地阅读副本和封面。此操作不会影响“文件”App 中的原文件。")
        }
    ...
    private var emptyLibrary: some View {
        VStack(spacing: 4) {
            ...
            JerreaderEmptyState(
                title: "把下一本书放进来",
                message: "导入 EPUB、PDF、DOCX 或 TXT。书籍只保存在这台设备上。",
            ...
            Button {
                ...
                Label("从备份恢复", systemImage: "arrow.uturn.backward.circle")
                    .font(.subheadline)
                    .padding(.horizontal, 8)
            }
            ...
            Text("装过 Jerreader 的话，选中以前的备份文件即可恢复书架、进度和备份计划。")
                .font(.caption)
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
                .padding(.top, 6)

            Label("本机保存，不会上传", systemImage: "lock.fill")
                .font(.caption)
                .foregroundStyle(.secondary)
                .padding(.top, 10)
        ...
        ScrollView {
            LazyVStack(alignment: .leading, spacing: 26) {
                ...
                VStack(alignment: .leading, spacing: 16) {
                    JerreaderSectionTitle(
                        title: "所有书籍",
                        detail: "\(displayedBooks.count) 本 · \(sortOrder.title)",
                    ...
                    if displayedBooks.isEmpty {
                        ContentUnavailableView(
                            ...
                            description: Text("请清除搜索文字或切换文件夹。")
                        )
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            HStack(spacing: 8) {
                ...
                Text(startedBooks.isEmpty ? "从一本喜欢的书开始" : "只记录本机阅读进度")
                    .font(.caption2)
                    .foregroundStyle(.tertiary)
                    .lineLimit(1)
            }
...
private extension TimeInterval {
    var readerDurationText: String {
        ...
        if totalMinutes < 1 { return self > 0 ? "<1 分钟" : "0 分钟" }
